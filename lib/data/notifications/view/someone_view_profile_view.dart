...
class SomeoneViewProfileView extends StatelessWidget {
  final controller = Get.find<SomeoneViewProfileController>();

  SomeoneViewProfileView({super.key});
                          ...
                          children: [
                                Center(
                                  child: Column(
                                    children: [
                                      AppTextFont(
                                        '${controller.profileData.value.firstName} ${controller.profileData.value.lastName}, ${controller.profileData.value.age}',

...
Future<void> _firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  ...
  await NotificationService1.showLocalNotification(message);
}
...
class NotificationService1 {
  ...
  static void redirectFromNotification(Map<String, dynamic> payload) async {
